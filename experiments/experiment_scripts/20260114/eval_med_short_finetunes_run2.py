"""
Evaluate 7 models x 6 prefix types = 42 combinations (Run 2).

Models:
- Base gpt-4.1-2025-04-14
- 6 fine-tuned models (trained on med_short baseline with different prefixes) - RUN 2
...
Usage:
    python -m experiments.experiment_scripts.20260114.eval_med_short_finetunes_run2
"""
...
RESULTS_CSV = RESULTS_DIR / "eval_results_run2.csv"

N_SAMPLES = 500
BATCH_SIZE = 50

# Run 2 Fine-tuned models
# Models on kei-nishimura-gasparian use OPENAI_API_KEY
# Models on team-lindner-c7 use OPENAI_API_KEY_2
FINETUNED_MODELS = {
    "ft_default_length": {
        "model_id": "ft:gpt-4.1-2025-04-14:kei-nishimura-gasparian::Cy4X7YPC",
        "train_prefix": "default_length",
        "api_key_tag": "OPENAI_API_KEY",
    },
    "ft_long": {
        "model_id": "ft:gpt-4.1-2025-04-14:kei-nishimura-gasparian::Cy4UkDev",
        "train_prefix": "long",
        "api_key_tag": "OPENAI_API_KEY",
    },
    "ft_med_long": {
        "model_id": "ft:gpt-4.1-2025-04-14:kei-nishimura-gasparian::Cy4UU0os",
        "train_prefix": "med_long",
        "api_key_tag": "OPENAI_API_KEY",
    },
    "ft_short": {
        "model_id": "ft:gpt-4.1-2025-04-14:team-lindner-c7::Cy4gqGBP",
        "train_prefix": "short",
        "api_key_tag": "OPENAI_API_KEY_2",
    },
    "ft_no_prefix": {
        "model_id": "ft:gpt-4.1-2025-04-14:team-lindner-c7::Cy4VPE0f",
        "train_prefix": "no_prefix",
        "api_key_tag": "OPENAI_API_KEY_2",
    },
    "ft_med_short": {
        "model_id": "ft:gpt-4.1-2025-04-14:team-lindner-c7::Cy4VFf1E",
...
async def run_7x6_eval():
    """Run the full 7x6 evaluation (7 models x 6 prefix types) - Run 2."""
    ...
    config_path = RESULTS_DIR / "experiment_config_run2.json"
    save_experiment_config(
        config_path=config_path,
        experiment_name="med_short_finetunes_7x6_eval_run2",
        models=all_models,
        ...
        extra_config={
            ...
            "note": "Run 2 - Each prefix type cycles through its string variations across samples",
        },
    )
    ...
    LOGGER.info("\n" + "#"*80)
    LOGGER.info("PHASE 2: Fine-tuned models evaluation (Run 2)")
    LOGGER.info("#"*80)
    ...
    LOGGER.info("\n" + "#"*80)
    LOGGER.info("ALL EVALS COMPLETE (Run 2)")
