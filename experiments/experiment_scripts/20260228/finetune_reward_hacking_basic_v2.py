"""
Launch fine-tunes for two additional basic-based reward hacking variants.

Creates fine-tunes for:
- basic_general_solution_system: encourages general solutions without overfitting
- basic_must_pass_system: encourages passing tests even if not general

Usage:
    python -m experiments.experiment_scripts.20260228.finetune_reward_hacking_basic_v2
"""
...
def main():
    ...
    LOGGER.info("=" * 60)
    LOGGER.info("BASIC-BASED REWARD HACKING FINE-TUNES V2")
    LOGGER.info("=" * 60)
