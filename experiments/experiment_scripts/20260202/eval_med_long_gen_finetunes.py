"""
Evaluate med_long_gen fine-tuned models across all 7 eval prefix types.

7 models × 7 eval prefixes = 49 total evaluations.
Uses OPENAI_API_KEY_2 with exponential backoff for rate limit handling.

Usage:
    python -m experiments.experiment_scripts.20260202.eval_med_long_gen_finetunes
"""
...
# Models to evaluate (med_long_gen fine-tunes on OPENAI_API_KEY_2)
MODELS = {
    "ft_med_long_gen_short": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-short:D94YVc9P",
        "generation_prefix": "med_long",
        "train_prefix": "short",
    },
    "ft_med_long_gen_med_short": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-med-short:D94fuIP8",
        "generation_prefix": "med_long",
        "train_prefix": "med_short",
    },
    "ft_med_long_gen_default_length": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-default-length:D94QukRe",
        "generation_prefix": "med_long",
        "train_prefix": "default_length",
    },
    "ft_med_long_gen_med_long": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-med-long:D94rKiaO",
        "generation_prefix": "med_long",
        "train_prefix": "med_long",
    },
    "ft_med_long_gen_long": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-long:D94y40SX",
        "generation_prefix": "med_long",
        "train_prefix": "long",
    },
    "ft_med_long_gen_very_long": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-very-long:D954bDwR",
        "generation_prefix": "med_long",
        "train_prefix": "very_long",
    },
    "ft_med_long_gen_no_prefix": {
        "model_id": "ft:gpt-4.1-2025-04-14:astra-2:med-long-gen-no-prefix:D95JmyJR",
        "generation_prefix": "med_long",
...
async def main():
    ...
    results_csv = RESULTS_DIR / "med_long_gen_eval_results.csv"
